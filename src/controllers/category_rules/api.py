"""
src/controllers/category_rules/api.py
Web API Router for Category Rules endpoints.
"""
...
from src.controllers.category_rules.model import CreateRuleRequest, UpdateRuleRequest
from src.services.category_rules.service import CategoryRulesService
...
async def list_rules(
    ...
    return {
        "status": "ok",
        "rules": [CategoryRulesService.rule_to_dict(r) for r in rules],
        "categories": [
...
async def create_rule(
    ...
    CategoryRulesService.validate_category(body.category)
    ...
    try:
        ...
        await db.commit()
        return {"status": "ok", "rule": CategoryRulesService.rule_to_dict(rule)}
